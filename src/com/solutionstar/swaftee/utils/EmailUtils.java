...
public class EmailUtils {
	...
	public HashMap<String, String> getLastGmailfrom(String userName, String passWord, String fromEmail)
			throws Exception {
		return getLastmailfromImap(userName, passWord, fromEmail, WebDriverConstants.GMAIL_IMAP_HOST);
	}

	public HashMap<String, String> getLastXomeMailfrom(String userName, String passWord, String fromEmail)
			throws Exception {
		return getLastExchangeMailfrom(userName, passWord, fromEmail, WebDriverConstants.SOLUTIONSTAR_IMAP_HOST,
				WebDriverConstants.SOLUTIONSTAR_DOMAIN_NAME);
	}
	...
	private HashMap<String, String> getLastmailfromImap(String userName, String passWord, String fromEmail,
		...
		try {
			...
			for (int emailCnt = 0; emailCnt < WebDriverConstants.EMAIL_PULL_LIMIT
					&& totalCnt - emailCnt > 0; emailCnt++) {
