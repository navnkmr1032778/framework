...
public class CommonUtils {
	...
	public int getMonthDiffBtwnDatesByMonthAndYear(String from, String to) {
		try {
			...
			return (Months.monthsBetween(date11.toLocalDate().withDayOfMonth(1), date12.toLocalDate().withDayOfMonth(1)).getMonths());
		} catch (Exception ex) {
			logger.info(ExceptionUtils.getFullStackTrace(ex));
			return -1;
		}
	 ...
	 */
	public void copyViaSFTP(String hostname, int port, String username, String password, String sourceLocation, String destination, List<String> files) {
	...
	public void copyToSFTPLocation(String hostname, int port, String username, String password, String sourceLocation, String destination, List<String> files) throws SftpException {
	...
	public List<String> listFilesInSFTPLocation(String hostname, int port, String username, String password, String sourceLocation) {
	...
	public Collection<? extends String> listFilesInSFTPLocation(String hostname, int port, String username, String password, String sourceLocation, Date startTime, String fileExtension) {
		List<String> list = new ArrayList<String>();
		try {
			channelSftp = getChannelSftp(hostname, port, username, password);
	...
	public Collection<? extends String> listFilesInSFTPLocation(String hostname, int port, String username, String password, String sourceLocation, Date startTime) {
	...
	public List<String> docToList(String filePath) {
		...
		try {
			lines = FileUtils.readLines(new File(getCurrentWorkingDirectory() + WebDriverConstants.PATH_TO_TEST_DATA_FILE + filePath));
		} catch (Exception e) {
			e.printStackTrace();
		}
		return lines;
	...
	public boolean writeToExcelTildeSeparatedData(String filePath, String sheetName, List<String> dataList) {
		try {
			HSSFWorkbook workbook = new HSSFWorkbook();
			HSSFSheet sheet = workbook.createSheet(sheetName);
			int excelRowCounter = 0;
			Map<String, Object[]> data = new HashMap<String, Object[]>();
			for (String eachString : dataList) {
				Object eachRow[] = eachString.split("~");
				data.put(++excelRowCounter + "", eachRow);
			}
