...
public interface ImageComparison {
	...
	/***
	 * gets all files and folders from compare->(given class name) folder stores the
	 * file and folder names in the structure:compareFilesMap Map String Map String
	 * List<String> className_Instance ---> methodName---> Screenshots File Name
	 * 
	 */
	...
	/***
	 * gets all files and folders from compare->(given class name/Device_browser)
	 * folder stores the file and folder names in the structure:baseFilesMap Map
	 * String List<String> methodName---> Screenshots File Name returns the
	 * map<method_name_folder,<base_image,List<compare_images>>
	 */
	...
	/**
	 * generates html report with data provided using resultMap and stores in
	 * "testComparison.html"
	 * 
	 * @param resultMap
	 */
