...
public class TakeScreenshotUtils implements TakeScreenshot{
	...
	public TakeScreenshotUtils(boolean isDryRun,String baseDirectoryLocation,String currentDirectoryLocation,boolean isCompareImages)
	{
	...
	public void scrollElementToUserView(WebDriver driver,WebElement elem)
	{
		...
		javaScriptExecutor.executeScript("window.scrollTo(" + (elem.getLocation().x-500) + "," +(elem.getLocation().y-500) + ");");
	}
