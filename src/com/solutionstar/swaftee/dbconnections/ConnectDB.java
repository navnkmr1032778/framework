...
public class ConnectDB extends DatabaseConnection {
	...
	public Connection establishConnection() throws MyCoreExceptions {
		try {
			...
			con = DriverManager.getConnection(dbUrl, generateProperty(userName, passwd));

			return con;

		} catch (Exception e) {
			throw new MyCoreExceptions(
					"Exception while establishing db connection.." + ExceptionUtils.getRootCauseStackTrace(e));
		}
	}

	@Override
	public Connection establishConnection(String hostName, String port, String database, String userName, String passwd)
	...
	@Override
	public Connection establishConnection(String hostName, String database, String userName, String passwd)
			throws MyCoreExceptions {
		try {
			Class.forName(dbClassName);
	...
	public List<String[]> executeQueryForArray(String query) throws MyCoreExceptions {
		...
		try {
			...
			throw new MyCoreExceptions(
					"Exception while executing the query in db connection.." + e.getLocalizedMessage());
		}
		return resultHash;
	}
	...
	public String executeQueryForScalar(String query) throws MyCoreExceptions {
		try {
			...
			throw new MyCoreExceptions("Exception while executing the query in db connection.. "
