...
public class WebDriverConstants {
	...
	static {
	  Map<String, String> tmp = new LinkedHashMap<String, String>();
	  tmp.put("chrome", "https://chromedriver.storage.googleapis.com/75.0.3770.90/chromedriver_win32.zip");
	...
	static {
	  Map<String, String> tmp = new LinkedHashMap<String, String>();
	  tmp.put("chrome", "https://chromedriver.storage.googleapis.com/75.0.3770.90/chromedriver_mac64.zip");
	...
	static {
	  Map<String, String> tmp = new LinkedHashMap<String, String>();
	  tmp.put("chrome", "https://chromedriver.storage.googleapis.com/75.0.3770.90/chromedriver_linux64.zip");
